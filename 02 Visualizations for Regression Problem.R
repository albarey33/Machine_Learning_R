...
###########################################################.
# 1 LOAD DATA #### DEFINE FUNCTION FX_READ.AUTO--------
...
# * 3.1 Standard Deviation of Numerical columns ----
...
# * 3.2 Distribution of Categorical Variables - Frequency Tables ----
for(col in colnames(auto_prices)){
...
###########################################################.
# 4 VISUALIZATION - DISTRIBUTION OF VARIABLES  ----
# One variable graphs, charts, distribution and range

# * 4.1 BAR PLOTS - FREQUENCY CHARTS for Categorical features ------
...
# * 4.2 HISTOGRAMS - Distribution of Numerical features ------
...
#############################################################.
# 5 VISUALIZATION TWO DIMENSIONAL PLOTS -------
# Two variable charts, numerical features vs numerical Label
...
# * 5.1 Using ALPHA for Transparency -----------
...
# 6 VIZ - RELATION CATEGORICAL FIELDS vs NUMERIC LABEL ==========
...
#####################################################.
# 8 MULTI-AXIS VIEWS OF DATA  -------------

# * 8.1 Pair-wise scatter plots or scatter plot matrices ===========
numcols = c('curb.weight', 'engine.size', 'horsepower', 'city.mpg', 'price')
